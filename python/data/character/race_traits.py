...
dragonborn_race_traits = [
    {"name": "Draconic Ancestry",
     "description": '''You have draconic ancestry. Choose one type of dragon from the Draconic Ancestry table. Your breath weapon and damage resistance are determined by the dragon type.
        Black has Acid damage type with a breath weapon of 5 by 30 ft. line (Dex. save). Blue has Lightning damage type with a breath weapon of 5 by 30 ft. line (Dex. save). Brass has Fire damage type with a breath weapon of 5 by 30 ft. line (Dex. save). Bronze has Lightning damage type with a breath weapon of 5 by 30 ft. line (Dex. save). Copper has Acid damage type with a breath weapon of 5 by 30 ft. line (Dex. save). Gold has Fire damage type with a breath weapon of 15 ft. cone (Dex. save). Green has Poison damage type with a breath weapon of 15 ft. cone (Con. save). Red has Fire damage type with a breath weapon of 15 ft. cone (Dex. save). Silver has Cold damage type with a breath weapon of 15 ft. cone (Con. save). White has Cold damage type with a breath weapon of 15 ft. cone (Con. save).'''
    },
    {"name": "Breath Weapon", 
